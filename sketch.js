...
function draw() {
  ...
  if(gameState === INTRO){
    ...
    text("You will get to see your current height increasing on the top left corner when you will play the game.", width/12,height/1.77)
    text("Cover 5000 km to reach on the moon.", width/2.65, height/1.58);
